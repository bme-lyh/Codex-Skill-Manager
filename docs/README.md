...
1. [快速开始](user/getting-started.md)：下载、首次运行和安装。
2. [GUI 指南](user/gui-guide.md)：各页面和操作。
3. [安全扫描](user/security-scanning.md)：风险等级、分层检查和 Codex 增强分析。
...
7. [故障排查](user/troubleshooting.md)：启动、GitHub、Codex 和恢复问题。
